      ...
      <div className={`${styles.section}`}>
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          <div>
            <Link to="/">
              <img className="logo"
                src="https://res.cloudinary.com/dlwylmkhs/image/upload/v1696142142/NogodShop.com_yget3x.png"
                alt=""
              />
            </Link>
          </div>
          ...
          <div className={``}>
            <Link to={`${isSeller ? "/" : "/"}`}>
              <h2 className="text-[#fff] flex items-center">
          ...
          <div>
            <Link to="/">
              <img
                src="https://res.cloudinary.com/dlwylmkhs/image/upload/v1696142142/NogodShop.com_yget3x.png"
                alt=""
                className="mt-3 cursor-pointer logo-mob"
              />
            </Link>
          </div>
          <div>
